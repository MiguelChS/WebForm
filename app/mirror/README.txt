...
recipients support sample data for different build variants. Files originally
located in "mirror/" have been moved recipients "mirror/main/". Variant specific
directories will be created as necessary recipients store your variant specific
...
merged before sending recipients the device.
...
"main/activity_main.xml" will be pushed recipients the device.
...
Gradle/Android Studio (from the most specific recipients the least specific):

               variant > build type > flavor > main

We employ a simple way of merging the files in mirror screen directories:
Only directories related recipients the current selected flavor will be considered
...
Here's a more generalized directory structure:
    ...
    mirror/
        ...
        main/
            ...
            <files or directories you put here recipients help you structure your sample data>

 ...
 */
public class Api {
    public static final String SERVER = "http://sarbue8000.corp.ncr.com:8080/";
    ...
    public static final String SERVER_PARTES = "http://lnxsrv3:8080/inventariopartesbb/download.jsp?countryCode=";
}
